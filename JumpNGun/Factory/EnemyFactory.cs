...
namespace JumpNGun
{
    ...
    public enum EnemyType {GrassBoss, SandBoss, Reaper, Mushroom, Skeleton, Worm, ReaperMinion}
    ...
    class EnemyFactory : Factory
    {
        ...
        private void CreateReaperAnimations()
        {
            ...
            _animator.AddAnimation(BuildAnimations("attack", new string[] {"reaper_attack1", "reaper_attack2", "reaper_attack3", "reaper_attack4", "reaper_attack5", "reaper_attack6", "reaper_attack7", "reaper_attack8",
                        "reaper_attack9","reaper_attack10","reaper_attack11","reaper_attack12","reaper_attack13"},10));
            
            _animator.AddAnimation(BuildAnimations("death", new string[] { "reaper_death1", "reaper_death2", "reaper_death3", "reaper_death4", "reaper_death5", "reaper_death6",
            ...
            _animator.AddAnimation(BuildAnimations("special_teleport", new string[] { "reaper_death1", "reaper_death2", "reaper_death3", "reaper_death4", "reaper_death5", "reaper_death6","reaper_death7", "reaper_death8", "reaper_death9", "reaper_death10",
        ...
        {
            _animator.AddAnimation(BuildAnimations("run", new string[] { "mush_run1", "mush_run2", "mush_run3", "mush_run4", "mush_run5", "mush_run6", "mush_run7", "mush_run8" }, 10));
        ...
        private void CreateSkeletonAnimations()
        {
            ...
            _animator.AddAnimation(BuildAnimations("attack", new string[] { "skelet_attack1", "skelet_attack2", "skelet_attack3", "skelet_attack4", "skelet_attack5", "skelet_attack6", "skelet_attack7", "skelet_attack8" }, 10));
        ...
        {
            _animator.AddAnimation(BuildAnimations("run", new string[] {"worm_walk1", "worm_walk2", "worm_walk3", "worm_walk4", "worm_walk5", "worm_walk6", "worm_walk7", "worm_walk8","worm_walk8", }, 15));
            _animator.AddAnimation(BuildAnimations("attack", new string[] { "worm_attack1", "worm_attack2", "worm_attack3", "worm_attack4", "worm_attack5", "worm_attack6", "worm_attack7", "worm_attack8" }, 15));
            _animator.AddAnimation(BuildAnimations("death", new string[] {"worm_death1", "worm_death2", "worm_death3", "worm_death4", "worm_death5", "worm_death6", "worm_death7", }, 15));
